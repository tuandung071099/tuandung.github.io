	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="5grid-layout">
			<div class="row" id="content">
				<h1 style="text-align: center; padding-bottom: 20px; font-size: 30px">CẬP NHẬT TÀI LIỆU</h1>
				<form method="POST" action="./quan_tri_tai_lieu_sua_thuc_hien.php" enctype="multipart/form-data">
					<?php
					...
					<input type="hidden" name="txtID" value="<?php echo $row["id_tai_lieu"]; ?>">
					<p>
						Tên tài liệu:<br>
					...
					<p>
						<p>
							...
							<select name="txtDinhDang" style="width: 1150px">
								<option value="pdf" <?php if ($row["ma_dinh_dang"] == 'pdf') echo 'selected'; ?>>.PDF</option>
								<option value="docx" <?php if ($row["ma_dinh_dang"] == 'docx') echo 'selected'; ?>>.DOCX</option>
								<option value="pptx" <?php if ($row["ma_dinh_dang"] == 'pptx') echo 'selected'; ?>>.PPTX</option>
							</select>
						</p>
						<p>
							Số trang:<br>
