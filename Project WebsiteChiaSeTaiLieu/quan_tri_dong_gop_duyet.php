	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="5grid-layout">
			<div class="row" id="content">
				<h1 style="text-align: center; padding-bottom: 20px; font-size: 30px">DUYỆT ĐÓNG GÓP</h1>
				<form method="POST" action="./quan_tri_dong_gop_duyet_thuc_hien.php" enctype="multipart/form-data">
					<?php
					...
					<p>
						...
						<p>
							File tải liệu:<br>
							<input type="text" name="txtFileTaiLieu" style="width: 100%;" value="<?php echo $row["file"]; ?>">
						</p>
						<p>
							File ảnh:<br>
							<input type="text" name="txtFileAnh" style="width: 100%;" value="<?php echo $row["anh_tai_lieu"]; ?>">
						</p>
