...
namespace QuanLyCuaHang.Forms
{
    public partial class frmHangTonKho : Form
    {
        ...
        {
            string sql = "SELECT MaSP,TenSP,MaLoai,DonViTinh,DonGiaNhap,DonGiaBan,SoLuongTon,GioiHanTon FROM tblSP WHERE SoLuongTon>0" ;
        ...
        private void btnInHD_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["C2:I2"].Value = "BÁO CÁO HÀNG TỒN KHO";
            //Lấy thông tin các mặt hàng
            sql = "SELECT MaSP,TenSP,MaLoai,DonViTinh,DonGiaNhap,DonGiaBan,SoLuongTon,GioiHanTon FROM tblSP WHERE SoLuongTon>0";
